                    ...
                    {appliedJobs.length > 0 ? (
                        appliedJobs.map((job, index) => (
                            <div key={index} className="p-4 border-b border-gray-200">
                                ...
                                <p className="text-gray-600">
                                    <strong>{t('employerPage.applicantName')}:</strong>{' '}
                                    {job.applicant.name}
                                </p>
                                <p className="text-gray-600">
                                    <strong>{t('employerPage.applicantEmail')}:</strong>{' '}
                                    {job.applicant.email}
                                </p>
                            </div>
                        ))
...
export default withRoleProtection(Employer, ['company']);
